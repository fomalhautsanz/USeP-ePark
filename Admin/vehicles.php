...
<title>Vehicles — USeP ePark Admin</title>
...
<div class="layout">
  ...
  <div class="main" id="mainArea">
    <header class="topbar">
      <h2 class="topbar-title">Vehicles</h2>
  ...
  <span class="topbar-notif-dot"></span>
    ...
    <div class="page-content">
      <div class="page-header fade-up">
        <div class="breadcrumb"><a href="dashboard.html">Dashboard</a><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg><span>Vehicles</span></div>
        <h1>Vehicle Management</h1>
        <p>Registered vehicles and their parking status</p>
      </div>

      <div class="stats-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:20px;">
        <div class="stat-card fade-up delay-1">
          <div class="stat-header"><span class="stat-label">Total Registered</span></div>
          <div class="stat-value" data-target="128">0</div>
          <div class="stat-sub">All vehicle types</div>
        </div>
        <div class="stat-card success fade-up delay-2">
          <div class="stat-header"><span class="stat-label">Currently Inside</span></div>
          <div class="stat-value" data-target="18">0</div>
          <div class="stat-sub">Active sessions</div>
        </div>
        <div class="stat-card fade-up delay-3">
          <div class="stat-header"><span class="stat-label">Cars</span></div>
          <div class="stat-value" data-target="74">0</div>
          <div class="stat-sub">58% of fleet</div>
        </div>
        <div class="stat-card fade-up delay-4">
          <div class="stat-header"><span class="stat-label">Motorcycles</span></div>
          <div class="stat-value" data-target="54">0</div>
          <div class="stat-sub">42% of fleet</div>
        </div>
      </div>
      ...
      <div class="card fade-up delay-2">
        <div class="card-header">
          ...
          <div style="display:flex;gap:8px;align-items:center;">
            <select class="form-control" style="width:auto;padding:7px 32px 7px 12px;font-size:12px;" data-filter-table="vehicleTable" data-filter-col="3">
            ...
            <button class="btn btn-primary btn-sm" data-open-modal="addVehicleModal">
        ...
        <div class="toolbar" style="padding:14px 22px 0;">
          <div class="toolbar-search">
            ...
            <input type="text" placeholder="Search plate number, owner..." data-search-table="vehicleTable">
          </div>
          ...
          <table id="vehicleTable">
            ...
            <tbody>
              <tr>
                ...
                <td><span class="td-mono">ABJ 1234</span></td>
                <td><div class="user-card"><img src="../assets/avatars/avatar-faculty.svg" class="user-avatar" alt="JD" style="width:32px;height:32px;border-radius:6px;object-fit:cover;"><div><div class="user-info-name">Juan dela Cruz</div><div class="user-info-sub">Faculty</div></div></div></td>
                <td><span class="badge badge-info">Car</span></td>
                <td style="font-size:13px;">White · Toyota Vios</td>
                <td><span class="badge badge-success"><span class="badge-dot"></span>Inside</span></td>
                <td style="font-size:12px;color:var(--text-muted);">Today 8:42 AM</td>
                <td><div class="qr-placeholder" style="width:36px;height:36px;font-size:0;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h.01M14 17h.01M17 14h.01M17 17h.01M20 14h.01M20 17h.01M20 20h.01M17 20h.01M14 20h.01"/></svg></div></td>
                <td>
                  <div style="display:flex;gap:4px;">
                    <button class="btn btn-outline btn-icon btn-sm" title="View"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button>
                    <button class="btn btn-outline btn-icon btn-sm" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
                    <button class="btn btn-outline btn-icon btn-sm" title="Delete" style="color:var(--danger);"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button>
                  </div>
                </td>
              </tr>
              <tr>
                <td style="color:var(--text-muted);font-size:12px;">002</td>
                <td><span class="td-mono">XYZ 5678</span></td>
                <td><div class="user-card"><img src="../assets/avatars/avatar-student.svg" class="user-avatar" alt="MS" style="width:32px;height:32px;border-radius:6px;object-fit:cover;"><div><div class="user-info-name">Maria Santos</div><div class="user-info-sub">Student</div></div></div></td>
                <td><span class="badge badge-gold">Motorcycle</span></td>
                <td style="font-size:13px;">Black · Honda Click</td>
                <td><span class="badge badge-muted"><span class="badge-dot"></span>Outside</span></td>
                <td style="font-size:12px;color:var(--text-muted);">Today 8:38 AM</td>
                <td><div class="qr-placeholder" style="width:36px;height:36px;font-size:0;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h.01M14 17h.01M17 14h.01M17 17h.01M20 14h.01M20 17h.01M20 20h.01M17 20h.01M14 20h.01"/></svg></div></td>
                <td><div style="display:flex;gap:4px;"><button class="btn btn-outline btn-icon btn-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button><button class="btn btn-outline btn-icon btn-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button><button class="btn btn-outline btn-icon btn-sm" style="color:var(--danger);"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button></div></td>
              </tr>
              <tr>
                <td style="color:var(--text-muted);font-size:12px;">003</td>
                <td><span class="td-mono">MNO 9999</span></td>
                <td><div class="user-card"><img src="../assets/avatars/avatar-staff.svg" class="user-avatar" alt="PR" style="width:32px;height:32px;border-radius:6px;object-fit:cover;"><div><div class="user-info-name">Pedro Reyes</div><div class="user-info-sub">Staff</div></div></div></td>
                <td><span class="badge badge-info">Car</span></td>
                <td style="font-size:13px;">Silver · Mitsubishi Mirage</td>
                <td><span class="badge badge-success"><span class="badge-dot"></span>Inside</span></td>
              ...
              <tr>
                ...
                <td><span class="td-mono">AGF 3322</span></td>
                <td><div class="user-card"><img src="../assets/avatars/avatar-student.svg" class="user-avatar" alt="AG" style="width:32px;height:32px;border-radius:6px;object-fit:cover;"><div><div class="user-info-name">Ana Gomez</div><div class="user-info-sub">Student</div></div></div></td>
                <td><span class="badge badge-gold">Motorcycle</span></td>
                <td style="font-size:13px;">Red · Yamaha Mio</td>
                <td><span class="badge badge-muted"><span class="badge-dot"></span>Outside</span></td>
                <td style="font-size:12px;color:var(--text-muted);">Today 8:19 AM</td>
                <td><div class="qr-placeholder" style="width:36px;height:36px;font-size:0;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:18px;height:18px;"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><path d="M14 14h.01M14 17h.01M17 14h.01M17 17h.01M20 14h.01M20 17h.01M20 20h.01M17 20h.01M14 20h.01"/></svg></div></td>
                <td><div style="display:flex;gap:4px;"><button class="btn btn-outline btn-icon btn-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></button><button class="btn btn-outline btn-icon btn-sm"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button><button class="btn btn-outline btn-icon btn-sm" style="color:var(--danger);"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg></button></div></td>
              </tr>
            </tbody>

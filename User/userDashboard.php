...
<div class="layout">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="nav-item" href="logs.html" data-tooltip="Parking History">
        <span class="nav-icon">
      ...
      <a class="nav-item" href="transactions.html" data-tooltip="Transactions / Receipts">
        <span class="nav-icon">
  ...
  <div class="main" id="mainArea">
    ...
    <header class="topbar">
      ...
      <div class="topbar-user">
        <div class="topbar-avatar"><img src="../assets/avatars/avatar-guest.svg" class="topbar-avatar" alt="Admin" style="width:30px;height:30px;border-radius:6px;object-fit:cover;"></div>
        <div class="topbar-user-info">
          <div class="topbar-user-name">User</div>
          <div class="topbar-user-role">Guest</div>
        </div>
      </div>
    </header>
      ...
      <div class="card fade-up delay-1">
        ...
        <div class="profile-card-header">
          <div class="avatar-wrapper">
            <img src ="../User/assets/img/userDefaultProfile.jpg">
            </svg>
          </div>

          <button type="button" id="editProfileButton" onclick="window.location.href='editProfile.html'">
            Edit Profile
        ...
        <div class="card-body">
          ...
          <div class="info-grid">
            ...
            <div class="info-field">
              ...
              <span class="info-value">April 23, 2000</span>
            </div>
            ...
            <div class="info-field">
              ...
              <span class="info-value">JKL 3456</span>
            </div>
            ...
            <div class="info-field">
              ...
              <span class="info-value">09827444671</span>
            </div>
    ...
    Update Password
            ...
            <div style="margin-top: 10px; ">
              ...
              <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--border);">
                ...
                <!-- Wa pani link sa gmail or contact someshit-->
